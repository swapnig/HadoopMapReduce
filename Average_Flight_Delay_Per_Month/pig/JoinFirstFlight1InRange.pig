...
/* Filter  out  those  tuples  whose  flight 1 dates  is  not  between  June  2007  and May 2008 */
validTwoLegFlightsWithinDate = FILTER validTwoLegFlights BY ((YEAR1 == 2007 AND MONTH1 >= 6) OR (YEAR1 == 2008 AND MONTH1 <= 5));
...
store flightDelayAverage into 's3://swap-hw3/pig-execution/join_first_flight1_output';
